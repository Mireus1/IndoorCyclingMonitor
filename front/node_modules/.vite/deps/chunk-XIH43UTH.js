...
var MenuItem = React3.memo(React3.forwardRef(function MenuItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyMenuItem"
  });
...
var StableMenuItem = React3.forwardRef(function StableMenuItem2(props, ref) {
  const {
    contextValue,
    id
...
//# sourceMappingURL=chunk-XIH43UTH.js.map
